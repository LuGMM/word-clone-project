    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-10 text-sm rounded-sm border border-neutral-400 text-center hover:bg-neutral-200/80  bg-transparent focus:outline-none focus:ring-0"
        />
      ) : (
        <button
          onClick={() => {
...
const TextColorButton = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="pb-1.5 h-7 min-w-7 shrink-0 flex flex-col items-center justify-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
          <span className="size-5 font-bold ">A</span>
...
export const Toolbar = () => {
  ...
  return (
    <div className="bg-[3F1F4F9] px-2.5 py-0.5 rounded-[24px] min-h-[40px] flex items-center gap-x-0.5 overflow-x-auto">
      {sections[0].map((item) => (
