export const templates = [
  ...
  },
  {
    ...
    initialContent: `
    <h1>Software Development Proposal</h1> <h2>Project Overview</h2>
    ...
    <h2>Timeline</h2> <p>Project milestones and delivery schedule.</p>
  ...
  },
  {
    ...
    <h2>Project Goals</h2> <p>Key objectives and expected outcomes.</p>

    <h2>Implementation Plan</h2> <p>Strategy and methodology for project execution.</p>

    <h2>Resources Required</h2> <p>Team, equipment, and budget requirements.</p>
    `,
  },
  {
    id: "business-letter",
  ...
  },
  {
    ...
    <h2>Professional Summary</h2> <p>Brief overview of your professional background and key strengths.</p>
    ...
    <h2>Skills</h2> <p>List of relevant skills and competencies.</p>
    `,
  },
  {
    id: "cover-letter",
